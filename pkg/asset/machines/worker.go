...
func (w *Worker) Generate(dependencies asset.Parents) error {
	...
	for _, pool := range ic.Compute {
		...
		ignARODNS, err := dnsmasq.MachineConfig(installConfig.Config.ClusterDomain(), aroDNSConfig.APIIntIP, aroDNSConfig.IngressIP, "worker", aroDNSConfig.GatewayDomains, aroDNSConfig.GatewayPrivateEndpointIP, false)
		if err != nil {
